...
def setLoggingHandler():
    handler = logging.handlers.WatchedFileHandler(
            os.environ.get("LOGFILE", "./TalentMap.log"))
...
with st.sidebar:
#    st.title("🤗💬 TalentMap")
    st.image('/home/user/11_Mar/8_03/streamlit_login_auth_ui/TalentMap.jpeg', caption='Making talent search easier', width=300 )
    st.markdown(
        """
    ## About
